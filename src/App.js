...
import ratPark from "./images/ratPark.jpg";
import the_non_pro from './images/the_non_pro.jpg'
...
import Adamnovak1 from './images/Adamnovak1.png'
...
import TextBlock7 from "./txtBlock7";
...
function App() {
  return (
    <div className="App">
      <Parallax className='img' strength={100} bgImage={ratPark}>
        <div className="content">
          <div className="text-content"></div>
        </div>
      </Parallax>
      <TextBlock />
      <Parallax className='img' strength={100} bgImage={the_non_pro}>
        <div className="content">
          <div className="text-content"></div>
        </div>
      </Parallax>
      ...
      <TextBlock8 />
      <Parallax className='img1' strength={100} bgImage={Adamnovak1}>
        <div className="content">
          <div className="text-content"></div>
        </div>
      </Parallax>
